...
r2cm::eColor Convert_R2bixForegroundColor_to_R2CMColor( r2bix::ColorValue color_value )
{
	...
	case r2bix::eForegroundColor::FG_LightLed:		return r2cm::eColor::FG_LightRed;
...
r2cm::eColor Convert_R2bixBackgroundColor_to_R2CMColor( r2bix::ColorValue color_value )
{
	...
	case r2bix::eBackgroundColor::BG_LightLed:		return r2cm::eColor::BG_LightRed;
...
void Utility4Test::DrawTextureFrame( const short x, const short y, const r2bix_render::TextureFrame& frame )
{
