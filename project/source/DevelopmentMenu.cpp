...
#include "mfm/mfm_DirectorConfig.h"
#include "mfm/mfm_EntryScene.h"
#include "mfm/mfm_VersionInfo.h"
...
r2cm::TitleFunctionT DevelopmentMenu::GetTitleFunction() const
{
	return []()->const char*
	{
		static const std::string ret =
			...
			+ ", " "<" + mfm::VersionInfo.String4Version + ">";
		return ret.c_str();
	};
}
r2cm::DescriptionFunctionT DevelopmentMenu::GetDescriptionFunction() const
{
	return []()->const char*
	{
		static const std::string ret =
			std::string()
			+ mfm::VersionInfo.String4VersionRule
			+ "\n"
			  "\n"
			  "\n"
			...
			+ "\n"
			  "\n"
			  "\n"
			+ mfm::VersionInfo.String4Road2Version_0_0_0_0;
		return ret.c_str();
	};
}
r2cm::WriteFunctionT DevelopmentMenu::GetWriteFunction() const
{
	return []( r2cm::MenuProcessor* ret )
	{
		...
		ret->AddItem(
			32
			, r2cm::eColor::BG_Blue
			, []()->const char* { return "MineFinderMini"; }
			, []()->r2cm::eDoLeaveAction
			{
...

				{
					...
					// Setup
					//
					r2bix::Director director( mfm::DirectorConfig );
					director.Setup( mfm::EntryScene::Create( director ) );
